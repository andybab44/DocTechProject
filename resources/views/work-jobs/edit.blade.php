...
@section('title', 'Edit – ' . $workJob->title)

@section('content')
<div class="mb-6 flex items-center gap-4">
    <a href="{{ route('work-jobs.show', $workJob) }}" class="text-sm text-indigo-600 hover:underline">← Back</a>
    <h1 class="text-2xl font-semibold text-gray-800">Edit Work Job</h1>
</div>
