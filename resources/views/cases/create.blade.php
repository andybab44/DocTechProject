...
<div class="mb-6 flex items-center gap-4">
    ...
    <h1 class="text-2xl font-semibold text-stone-800">New Case</h1>
</div>
    ...
    <form method="POST" action="{{ route('cases.store') }}" class="space-y-5">
        ...
        <div>
            ...
            <textarea id="notes" name="notes" rows="2"
                      class="w-full rounded-lg border border-stone-300 px-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-teal-400 @error('notes') border-red-400 @enderror">{{ old('notes') }}</textarea>
