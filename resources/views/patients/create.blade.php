...
<div class="mb-6">
    ...
    <h1 class="text-2xl font-semibold text-gray-800 mt-1">{{ __('app.patients.create_title') }}</h1>
</div>
...
<div class="bg-white rounded-lg shadow p-6 max-w-2xl">
    <form method="POST" action="{{ route('patients.store') }}" class="space-y-5">
        ...
        <div class="flex items-center gap-3 pt-2">
            ...
            <a href="{{ route('patients.index') }}" class="text-sm text-gray-500 hover:underline">{{ __('app.cancel') }}</a>
        </div>
    </form>
</div>
@endsection
