...
<div class="mb-6">
    ...
    <h1 class="text-2xl font-semibold text-stone-800 mt-1">{{ __('app.inventory.create_title') }}</h1>
</div>
...
<div class="bg-white rounded-xl shadow-sm border border-stone-200 p-6 max-w-2xl">
    <form method="POST" action="{{ route('admin.inventory.store') }}" class="space-y-5">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                <label class="block text-sm font-medium text-stone-700 mb-1">{{ __('app.inventory.field_quantity') }}</label>
